...
docker run --name oc-cluster-up -d -v /etc/docker/certs.d/:/certs/ -v /tmp/:/tmp/ -v /var/run/docker.sock:/var/run/docker.sock -v /var/lib/docker:/var/lib/docker gustavonalle/oc-cluster-up
